...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c8 = function(entry: any) { return entry };
  const peg$c9 = ":";
  const peg$c10 = peg$literalExpectation(":", false);
  const peg$c11 = function(key: any, value: any) { return {key, value} };
  const peg$c12 = /^[a-zA-Z0-9_]/;
  const peg$c13 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_"], false, false);
  const peg$c14 = function(entries: any) { return entries.join('') };
  const peg$c15 = "[";
  ...
  const peg$c28 = function(positive: any) { return -1 * positive };
  const peg$c29 = /^[1-9]/;
  ...
  const peg$c39 = function() { return 0 };
  const peg$c40 = "true";
  const peg$c41 = peg$literalExpectation("true", false);
  const peg$c42 = "TRUE";
  const peg$c43 = peg$literalExpectation("TRUE", false);
  const peg$c44 = "T";
  const peg$c45 = peg$literalExpectation("T", false);
  const peg$c46 = function() { return true };
  const peg$c47 = "false";
  const peg$c48 = peg$literalExpectation("false", false);
  const peg$c49 = "FALSE";
  const peg$c50 = peg$literalExpectation("FALSE", false);
  const peg$c51 = "F";
  const peg$c52 = peg$literalExpectation("F", false);
  const peg$c53 = function() { return false };
  const peg$c54 = "NULL";
  const peg$c55 = peg$literalExpectation("NULL", false);
  const peg$c56 = "null";
  const peg$c57 = peg$literalExpectation("null", false);
  const peg$c58 = function() { return null };
  const peg$c59 = "undefined";
  const peg$c60 = peg$literalExpectation("undefined", false);
  const peg$c61 = function() { return undefined };
  const peg$c62 = peg$otherExpectation("whitespace");
  const peg$c63 = /^[ \r\t\n]/;
