...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c43 = peg$classExpectation([["0", "9"], "a", "b", "c", "d", "e", "f"], false, false);
  const peg$c44 = function(digits: any) { return Number.parseInt(`0x${digits.join('')}`, 16) };
  const peg$c45 = "0o";
  ...
  const peg$c61 = function() { return true };
  const peg$c62 = "false";
